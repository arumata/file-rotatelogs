...
[![Build Status](https://travis-ci.org/arumata/file-rotatelogs.png?branch=master)](https://travis-ci.org/arumata/file-rotatelogs)

[![GoDoc](https://godoc.org/github.com/arumata/file-rotatelogs?status.svg)](https://godoc.org/github.com/arumata/file-rotatelogs)
...
import (
  ...
  apachelog "github.com/arumata/apache-logformat"
  rotatelogs "github.com/arumata/file-rotatelogs"
)
...
```
go get github.com/arumata/file-rotatelogs
```
...
such as `github.com/arumata/apache-logformat`.

```go
import(
  "log"
  "github.com/arumata/file-rotatelogs"
)
